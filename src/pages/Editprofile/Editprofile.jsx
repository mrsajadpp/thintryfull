...
function Editprofile(props) {
    ...
    async function handleSubmit(event) {
        ...
        try {
            let response = await Axios.get('http://api.thintry.com/api/user/update', { params: { firstname: formData.get('firstname'), lastname: formData.get('lastname'), username: formData.get('username'), about: formData.get('about'), _id: userData._id } }, {
                headers: {
    ...
    const handleUSername = (event) => {
        ...
        if (newValue.length <= 0) {
            ...
            Axios.get(
                'http://api.thintry.com/api/username/check',
