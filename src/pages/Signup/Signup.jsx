...
function Signup(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      let response = await Axios.get('http://192.168.1.3:3001/api/auth/signup', { params: { firstname: formData.get('firstname'), lastname: formData.get('lastname'), username: formData.get('username'), password: formData.get('password'), email: formData.get('email') } }, {
        headers: {
