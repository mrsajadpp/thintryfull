...
function Signup(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      let response = await Axios.get('http://api.thintry.com/api/auth/signup', { params: { firstname: formData.get('firstname'), lastname: formData.get('lastname'), username: formData.get('username'), password: formData.get('password'), email: formData.get('email') } }, {
        headers: {
